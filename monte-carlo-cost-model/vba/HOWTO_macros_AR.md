...
| `DeleteCostLine` | Cost Lines D2 | يحذف البند المحدّد (الصف اللي مؤشّر فيه) + صف بروفايلنقه |
| `AddRisk` | Risk Register A2 | يضيف خطر منسّق بالكامل + صف بروفايلنق |
| `DeleteRisk` | Risk Register D2 | يحذف الخطر المحدّد + صف بروفايلنقه |
...
> زرّان لكل وحدة: **A2 = Add** و **D2 = Delete** — ارسم زر فوق كل خلية واربطه بالماكرو.

**الترقيم تلقائي:** عمود **No.** يرقّم 1، 2، 3… بنفسه (والمخاطر R1، R2…)، ويتجدّد
تلقائيًا لما تضيف أو تحذف — ما تحتاج ترقّم يدويًا.

**الحذف:** روح لورقة Cost Lines (أو Risk Register)، أشّر على أي خلية في صف البند
اللي تبي تحذفه، واضغط زر Delete (أو شغّل DeleteCostLine من Alt+F8).
